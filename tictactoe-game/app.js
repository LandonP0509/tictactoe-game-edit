...
// executed when player clicks one of the table cells
// Implemented a try block on the cellClicked function
function cellClicked(id) {
    ...
    if (winner === 0) {
        ...
        console.error("Error during cellClicked:", error.message);
        return false;
    }
}
...
//         restartGame();
//     } else {
//         alert("Thank you for playing the game! This was developed by Landon Phillippi.")
//     }
// }

function restartPrompt() {

    console.log("The game is restarting...");
...
function endGame(who) {
    ...
    setTimeout(function() {
        ...
        if (playAgain) {
            restartPrompt();  // This will restart the game
        } else {
            alert("Thank you for playing! This was developed by Landon Phillippi."); //This will thank the player
        }
    }, 800);
}
